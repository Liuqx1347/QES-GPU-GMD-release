...
protected:
  ...
  */
  ...
  // GPU ¶Ë¾µÏñ CPU µÄ DomainBC ÀàÐÍ
  // 0 = exiting, 1 = periodic, 2 = reflection
  int gpuBCType_x = 0;
  int gpuBCType_y = 0;
  int gpuBCType_z = 0;
  ...
  int generateParticleList(float, WINDSGeneralData *, TURBGeneralData *, std::vector<Particle*> *newParticlesVec = nullptr);
